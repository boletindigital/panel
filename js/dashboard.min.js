...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(e,t){t.otherwise("/entrar"),e.state("general",{url:"/general",templateUrl:"templates/dashboard.html"}).state("mis-expedientes",{url:"/mis-expedientes",templateUrl:"templates/mis-expedientes.html"}).state("busqueda",{url:"/busqueda",templateUrl:"templates/busqueda.html"}).state("entrar",{url:"/entrar",templateUrl:"templates/login.html"})}]);
...
angular.module("RDash").controller("BusquedaCtrl",["$scope","Acuerdos","Instancias","Usuario","$stateParams","toastr",function(e,n,i,a,t,o){e.id=t.fold,e.api={},e.acuerdos=[],e.misExpedientes=[],e.instancia={selected:{clave:"JF01",organo:"J",materia:"F",numero:1,nombre:"Juzgado Familiar 1"}},e.expediente={input:20142349},e.instancias=[{clave:"JF01",organo:"J",materia:"F",numero:1,nombre:"Juzgado Familiar 1"},{clave:"JC01",organo:"J",materia:"C",numero:1,nombre:"Juzgado Civil 1"},{clave:"JO01",organo:"J",materia:"O",numero:1,nombre:"Juzgado Oral 1"}],i.all().then(function(n){e.instancias=n}),a.misExpedientes().then(function(n){e.misExpedientes=n}),e.pagination={current:1,totalObjects:0,objectsPerPage:100},e.filter={},e.isFavourite=function(){var n={};n.claveInstancia=e.instancia.clave,n["año"]=(""+e.expediente.input).substring(0,4),n.consecutivo=(""+e.expediente.input).substring(4,20);for(var i=0;i<e.misExpedientes.length;i++)if(n.claveInstancia.endsWith(e.misExpedientes[i].instancia)&&n["año"]===e.misExpedientes[i]["año"]&&n.consecutivo===e.misExpedientes[i].consecutivo)return!0;return!1},e.watchCurrentExpediente=function(){var n={};n.organo=e.instancia.selected.organo,n.materia=e.instancia.selected.materia,n.numero=e.instancia.selected.numero,n["año"]=(""+e.expediente.input).substring(0,4),n.consecutivo=(""+e.expediente.input).substring(4,20),a.newExpedienteWatcher(n).then(function(e){var n=e.expediente.instancia+" "+e.expediente["año"]+"/"+e.expediente.consecutivo;o.success("Guardado en 'Mis expedientes'.",n)})},e.pageChanged=function(){e.api.weAreWaiting=!0;var i={};angular.copy(e.filter,i),i.page=e.pagination.current,i.organo=e.instancia.selected.organo,i.materia=e.instancia.selected.materia,i.numero=e.instancia.selected.numero,i["año"]=(""+e.expediente.input).substring(0,4),i.consecutivo=(""+e.expediente.input).substring(4,20),console.log("boletin::expediente::",e.expediente),n.getByFilter(i).then(function(n){e.acuerdos=n.data,e.pagination.totalObjects=n.total,e.filter=i,e.filter.page=void 0,e.api.weAreWaiting=!1})},e.pageChanged()}]);
