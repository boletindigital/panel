...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(e,t){t.otherwise("/entrar"),e.state("general",{url:"/general",templateUrl:"templates/dashboard.html"}).state("busqueda",{url:"/busqueda",templateUrl:"templates/busqueda.html"}).state("entrar",{url:"/entrar",templateUrl:"templates/login.html"})}]);
