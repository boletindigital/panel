angular.module("RDash",["ui.bootstrap","ui.router","ngCookies","angularUtils.directives.dirPagination","ui.select","ngSanitize","ui.mask","angular-jwt","toastr","pretty-checkable"]);
...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(e,t){t.otherwise("/entrar"),e.state("general",{url:"/general",templateUrl:"templates/dashboard.html"}).state("mis-expedientes",{url:"/mis-expedientes",templateUrl:"templates/mis-expedientes.html"}).state("busqueda",{"abstract":!0,url:"/busqueda",template:'<div ui-view class=""></div>'}).state("busqueda.por-expediente",{url:"/por-expediente/{claveInstancia}/{agno}/{consecutivo}",templateUrl:"templates/busqueda.html"}).state("entrar",{url:"/entrar",templateUrl:"templates/login.html"})}]);
function AlertsCtrl(e){e.alerts=[{type:"info",msg:"Este es el panel de vista general. Aquí te mostramos un resumen del sistema."}],e.addAlert=function(){e.alerts.push({msg:"Another alert!"})},e.closeAlert=function(t){e.alerts.splice(t,1)}}angular.module("RDash").controller("AlertsCtrl",["$scope",AlertsCtrl]);
angular.module("RDash").controller("BusquedaCtrl",["$scope","Acuerdos","Instancias","Usuario","$stateParams","toastr",function(e,n,a,t,i,s){var c={claveInstancia:i.claveInstancia,"año":parseInt(i.agno),consecutivo:parseInt(i.consecutivo),numero:parseInt(i.claveInstancia.substring(2,4)),organo:i.claveInstancia.substring(0,1),materia:i.claveInstancia.substring(1,2)};e.api={},e.acuerdos=[],e.misExpedientes=[],e.instancia={selected:{clave:"JC01",organo:"J",materia:"C",numero:1,nombre:"Juzgado Civil 1"}},e.expediente={input:20142349},e.instancias=[],a.all().then(function(n){e.instancias=n}),t.misExpedientes().then(function(n){e.misExpedientes=n}),e.pagination={current:1,totalObjects:0,objectsPerPage:100},e.filter={},e.isFavourite=function(){var n={};n.claveInstancia=e.instancia.selected.clave,n["año"]=parseInt((""+e.expediente.input).substring(0,4)),n.consecutivo=parseInt((""+e.expediente.input).substring(4,20));for(var a=0;a<e.misExpedientes.length;a++)if(n.claveInstancia.endsWith(e.misExpedientes[a].expediente.instancia)&&n["año"]===e.misExpedientes[a].expediente["año"]&&n.consecutivo===e.misExpedientes[a].expediente.consecutivo)return!0;return!1},e.watchCurrentExpediente=function(){var n={};n.organo=e.instancia.selected.organo,n.materia=e.instancia.selected.materia,n.numero=e.instancia.selected.numero,n["año"]=(""+e.expediente.input).substring(0,4),n.consecutivo=(""+e.expediente.input).substring(4,20),t.newExpedienteWatcher(n).then(function(e){var n=e.expediente.instancia+" "+e.expediente["año"]+"/"+e.expediente.consecutivo;s.success("Expediente guardado.",n)})},e.pageChanged=function(){e.api.weAreWaiting=!0;var a={};angular.copy(e.filter,a),a.page=e.pagination.current,a.organo=e.instancia.selected.organo,a.materia=e.instancia.selected.materia,a.numero=e.instancia.selected.numero,a["año"]=(""+e.expediente.input).substring(0,4),a.consecutivo=(""+e.expediente.input).substring(4,20),n.getByFilter(a).then(function(n){e.acuerdos=n.data,e.pagination.totalObjects=n.total,e.filter=a,e.filter.page=void 0,e.api.weAreWaiting=!1})},isNaN(c["año"])||isNaN(c.consecutivo)||(e.expediente.input=""+c["año"]+c.consecutivo),c.claveInstancia&&(e.instancia={selected:{clave:c.claveInstancia,organo:c.organo,materia:c.materia,numero:c.numero,nombre:c.claveInstancia}}),e.pageChanged()}]);
...
angular.module("RDash").controller("MisExpedientesCtrl",["$scope","Usuario",function(e,n){e.misExpedientes=[],e.misExpedientesFilter={},n.misExpedientes().then(function(n){e.misExpedientes=n}),e.number=function(e){return e>1e6?Math.round(e/1e6*100)/100+"M":e+""}}]);
...
angular.module("RDash").factory("Usuario",["$http",function(e){var n="https://api.boletin.damianfernandez.mx",t={};return t.misExpedientes=function(){return e.get(n+"/expedientes/misExpedientes",{headers:{"Content-Type":"application/json"}}).then(function(e){return e.data})},t.newExpedienteWatcher=function(t){return e.post(n+"/expedientes/newWatcher",t,{headers:{"Content-Type":"application/json"}}).then(function(e){return e.data})},t}]);