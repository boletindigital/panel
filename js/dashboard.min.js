angular.module("RDash",["ui.bootstrap","ui.router","ngCookies","angularUtils.directives.dirPagination","ui.select","ngSanitize","ui.mask","angular-jwt"]);
...
angular.module("RDash").controller("LoginCtrl",["$scope","LoginProvider","$state",function(o,r,e){o.user={username:"",password:""},o.loginForm={message:"Continuar"},o.loginFormSubmit=function(){console.log("submit..."),t(o.user)};var n={working:!1},t=function(t){n.working||(n.working=!0,o.loginForm.isLoading=!0,o.loginForm.message="Conectando",r.login(t).then(function(r){if(n.working=!1,!r.data.username||!r.data.access_token)return void(o.loginError="Usuario o contraseña incorrectos");o.loginForm.isOk=!0,o.loginForm.message="¡Adelante!";var t=r.data.access_token;localStorage.setItem("DAF_access_jwt",t);var a=r.data.refresh_token;localStorage.setItem("DAF_refresh_jwt",a),e.go("busqueda")},function(r){o.loginForm.isLoading=!1,o.loginForm.isOk=!1,n.working=!1,401==r.status||"Unauthorized"==r.statusText?o.loginError="Usuario o contraseña incorrectos":(o.authError="Error del servidor. ",r.statusText&&(o.authError+=r.statusText))}))}}]);
