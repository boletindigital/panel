...
angular.module("pretty-checkable",[]).constant("prettyCheckableConfig",{activeClass:"checked",disabledClass:"disabled",toggleEvent:"click"}).controller("PrettyCheckableController",["prettyCheckableConfig",function(e){this.activeClass=e.activeClass||"checked",this.disabledClass=e.disabledClass||"disabled",this.toggleEvent=e.toggleEvent||"click"}]).directive("prettyRadio",function(){return{restrict:"E",require:["prettyRadio","ngModel"],controller:"PrettyCheckableController",link:function(e,a,l,n){var t=n[0],s=n[1];if(a.addClass("prettyradio"),a.prepend(angular.element("<a></a>")),"false"!==l.label){var i=e.$eval(l.label?l.label:l.value),r=angular.element("<label>"+i+"</label>");l.labelLeft?a.prepend(r):a.append(r)}l.$observe("disabled",function(e){s.$render()}),s.$render=function(){var n="true"===l.disabled||"false"===l.disabled?l.disabled:e.$eval(l.disabled),i="true"===l.ngDisabled||"false"===l.ngDisabled?l.ngDisabled:e.$eval(l.ngDisabled);a.find("a").toggleClass(t.activeClass,angular.equals(s.$modelValue,e.$eval(l.value))),a.find("a").toggleClass(t.disabledClass,!(!n&&!i))},a.bind(t.toggleEvent,function(){a.find("a").hasClass(t.activeClass)||a.find("a").hasClass(t.disabledClass)||e.$apply(function(){s.$setViewValue(e.$eval(l.value)),s.$render()})})},template:"<div ng-transclude></div>",replace:!0,transclude:!0}}).directive("prettyCheckbox",function(){return{restrict:"E",require:["prettyCheckbox","ngModel"],controller:"PrettyCheckableController",link:function(e,a,l,n){function t(){return s(l.value,!0)}function s(a,l){var n=e.$eval(a);return angular.isDefined(n)?n:l}function i(e){b.$setValidity("require",e||!f)}function r(){return a.find("a").hasClass(o.activeClass)}function d(){return angular.isArray(b.$modelValue)}function u(e){return d()?b.$modelValue.indexOf(e)>-1:angular.equals(b.$modelValue,e)}function c(e,a){var l=b.$modelValue;if(v){var n=[];d()&&angular.copy(l,n),l=n;var t=l.indexOf(e);a&&t>-1?l.splice(t,1):a||t!==-1||l.push(e)}else l=!a&&e;b.$setViewValue(l)}var o=n[0],b=n[1],f=!1,v=!1;if(a.addClass("prettycheckbox"),a.prepend(angular.element("<a></a>")),l.$observe("required",function(e){f=!!e,i(r())}),l.$observe("disabled",function(e){b.$render()}),angular.isDefined(l.multiple)&&(v=!0),"false"!==l.label){var g=e.$eval(l.label?l.label:l.value),C=angular.element("<label>"+g+"</label>");l.labelLeft?a.prepend(C):a.append(C)}b.$render=function(){var n="true"===l.disabled||"false"===l.disabled?l.disabled:e.$eval(l.disabled),s="true"===l.ngDisabled||"false"===l.ngDisabled?l.ngDisabled:e.$eval(l.ngDisabled);a.find("a").toggleClass(o.activeClass,u(t())),a.find("a").toggleClass(o.disabledClass,!(!n&&!s))},a.bind(o.toggleEvent,function(){a.find("a").hasClass(o.disabledClass)||e.$apply(function(){var e=r();c(t(),e),i(!e),b.$render()})})},template:"<div ng-transclude></div>",replace:!0,transclude:!0}});